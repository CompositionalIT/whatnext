...
Target.create "Azure" (fun _ ->
    ...
    let servicePlan = CoreTypes.ArmExpression.resourceId(Arm.Web.serverFarms, ResourceName "Default1", "Internal-CIT")
    ...
    let template = arm {
        ...
        add_resources [ storage; cosmos; app ]
    }

    template
    |> Deploy.execute "whatnext" Deploy.NoParameters
    |> ignore
)
